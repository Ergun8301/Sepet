        ...
        <div className="p-6 space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#39e3cf] focus:border-transparent"
            />
          </div>
          ...
          {formData.price_before && formData.price_after && parseFloat(formData.price_before) > 0 && (
            <div className="bg-green-100 border border-green-300 rounded-lg p-3 text-center">
              <span className="text-lg font-bold text-[#39e3cf]">
            ...
            <div className="border-t pt-4">
              <div className="flex items-center mb-3">
                <input
                  ...
                  className="w-4 h-4 text-[#39e3cf] rounded focus:ring-[#39e3cf]"
                />
              ...
              <div className="grid grid-cols-2 gap-4 mb-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#39e3cf] focus:border-transparent disabled:bg-gray-100 disabled:cursor-not-allowed"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
