  ...
  return (
    <>
      <div className="min-h-screen bg-gray-50">
        {/* Hero Section */}
        <div className="bg-gradient-to-br from-green-500 to-green-600 text-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-5xl font-bold mb-6">Turn Waste into Revenue</h1>
        ...
        <div id="benefits" className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Partner with ResQ Food?</h2>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Sign Up & Setup</h3>
                <p className="text-gray-600">Create your merchant account and set up your restaurant profile in minutes.</p>
              </div>
              <div className="text-center">
                <div className="bg-green-500 text-white w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">
                  2
                </div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">List Your Offers</h3>
                <p className="text-gray-600">Add surplus food items with discounted prices. Set pickup times and quantities.</p>
              </div>
              <div className="text-center">
                <div className="bg-green-500 text-white w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">
                  3
                </div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Serve Customers</h3>
                <p className="text-gray-600">Customers reserve and pick up their orders. You reduce waste and earn revenue.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="py-20 bg-green-500">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-sm text-green-200 mt-4">No setup fees • Cancel anytime • 24/7 support</p>
          </div>
        </div>
      </div>
